...
export const VISUAL_REVAMP_IMAGE_ASSETS: AssetEntry[] = [
  ...
  { key: VISUAL_REVAMP_KEYS.ARRAY_PLAINS_BG, path: `${VISUAL_REVAMP_BASE}/regions/array_plains_route_v3.png` },
  { key: VISUAL_REVAMP_KEYS.TWIN_RIVERS_BG, path: `${VISUAL_REVAMP_BASE}/regions/twin_rivers_route_v1.png` },
  { key: VISUAL_REVAMP_KEYS.HASH_HIGHLANDS_BG, path: `${VISUAL_REVAMP_BASE}/regions/hash_highlands_route_v1.png` },
  { key: VISUAL_REVAMP_KEYS.STACK_SPIRES_BG, path: `${VISUAL_REVAMP_BASE}/regions/stack_spires_route_v1.png` },
  { key: VISUAL_REVAMP_KEYS.QUEUE_CANALS_BG, path: `${VISUAL_REVAMP_BASE}/regions/queue_canals_route_v1.png` },
  { key: VISUAL_REVAMP_KEYS.TREE_CANOPY_BG, path: `${VISUAL_REVAMP_BASE}/regions/tree_canopy_route_v1.png` },
  { key: VISUAL_REVAMP_KEYS.GRAPH_NEXUS_BG, path: `${VISUAL_REVAMP_BASE}/regions/graph_nexus_route_v1.png` },
  { key: VISUAL_REVAMP_KEYS.CORE_BG, path: `${VISUAL_REVAMP_BASE}/regions/core_route_v1.png` },

...
/**
 * Echo Causeway trial tileset — generated by a deterministic PIL script
 * (art_sources/generate_prologue_trial_tileset.py), the Movement Gym
 * pattern: no imagegen, regenerable any time. Frame layout mirrors
 * src/scenes/prologueTrial/trialTiles.ts.
 */
export const PROLOGUE_TRIAL_KEYS = {
  TILESET: "prologue-trial-tileset",
} as const;

export const PROLOGUE_TRIAL_SHEET_ASSETS: AssetEntry[] = [
  {
    key: PROLOGUE_TRIAL_KEYS.TILESET,
    path: "assets/visual_revamp/prologue_trial/tileset_v1.png",
    frameWidth: 32,
    frameHeight: 32,
  },
];
